# Procesamiento y Gráficos Data Conclat
...
data <- data %>% 
  select(id,
         ...
         c07_03,   # Acuerdo: disminuir gasto público
         c07_04,   # Acuerdo: sindicatos tengan más poder
         c07_05,   # Acuerdo: redistribuir riquezas
         c07_06,   # Acuerdo: igualdad hombres y mujeres
         # Demográficas
         sexo=e01,
         edad=e02,
         e05,             # educ
...
```{r}
# Acuerdo: disminuir gasto público para evitar inflación
frq(data$c07_03)
...
data <- data %>%
  ...
  set_variable_labels(c07_03 = "Nivel de acuerdo: disminuir gasto público para evitar inflación (c07_03)")
...
data <- data %>%
  ...
  set_variable_labels(c07_03_acuerdo = "De acuerdo o Muy de acuerdo: disminuir gasto público para evitar inflación")
...
data <- data %>%
  ...
  set_variable_labels(c07_04 = "Nivel de acuerdo: sindicatos tengan más poder (c07_04)")
...
data <- data %>%
  ...
  set_variable_labels(c07_04_acuerdo = "De acuerdo o Muy de acuerdo: sindicatos tengan más poder")
...
data <- data %>%
  ...
  set_variable_labels(c07_05 = "Nivel de acuerdo: redistribuir riquezas (c07_05)")
...
data <- data %>%
  ...
  set_variable_labels(c07_05_acuerdo = "De acuerdo o Muy de acuerdo: redistribuir riquezas")
...
```{r}
# Acuerdo: igualdad entre hombres y mujeres
frq(data$c07_06)
...
data <- data %>%
  ...
  set_variable_labels(c07_06 = "Nivel de acuerdo: igualdad entre hombres y mujeres (c07_06)")
...
data <- data %>%
  ...
  set_variable_labels(c07_06_acuerdo = "De acuerdo o Muy de acuerdo: igualdad entre hombres y mujeres")
...
data_svy %>%
  ...
  labs(
    title = "Importancia de mejores salarios y condiciones laborales por sexo",
...
data_svy %>%
  ...
  geom_text(aes(label = round(promedio, 2)), 
            vjust = 1.3, size = 4, color = "white") +
  labs(
    title = "Importancia de mejores salarios y condiciones laborales por tramo etario",
    caption = "Nota: Datos ponderados. N = 2105",
    x = "Tramo de edad",
    y = "Promedio (escala 0-10)"
  ) +
...
data_svy %>%
  ...
  geom_text(aes(label = round(promedio, 2)), 
            vjust = 1.3, size = 4, color = "white") +
  labs(
    title = "Importancia de reducir la desigualdad en el país por sexo",
    caption = "Nota: Datos ponderados. N = 2105",
    x = "Sexo",
    y = "Promedio (escala 0-10)"
  ) +
...
data_svy %>%
  ...
  geom_text(aes(label = round(promedio, 2)), 
            vjust = 1.3, size = 4, color = "white") +
  labs(
    title = "Importancia de reducir la desigualdad en el país por tramo etario",
    caption = "Nota: Datos ponderados. N = 2105",
    x = "Tramo de edad",
    y = "Promedio (escala 0-10)"
  ) +
...
grafico <- ggplot(acuerdo, aes(x = sexo, y = prop_acuerdo)) +
  ...
  labs(
    title = "Acuerdo con que la desigualdad se debe a que los dueños de empresas pagan poco por sexo",
...
grafico <- ggplot(acuerdo, aes(x = edad_tramos, y = prop_acuerdo)) +
  ...
  scale_y_continuous(labels = scales::percent_format(accuracy = 1)) +
  labs(
    title = "Acuerdo con que la desigualdad se debe a que los dueños de empresas pagan poco por tramo etario",
    subtitle = "Proporción que responde De acuerdo (4) o Muy de acuerdo (5)",
    caption = "Nota: Datos ponderados. N = 2105",
    x = "Tramo de edad",
    y = "Porcentaje de acuerdo"
...
grafico <- ggplot(acuerdo, aes(x = sexo, y = prop_acuerdo)) +
  ...
  scale_y_continuous(labels = scales::percent_format(accuracy = 1)) +
  labs(
    title = "Acuerdo con que alto nivel vida dueños empresas es por pagar poco por sexo",
    subtitle = "Proporción que responde De acuerdo (4) o Muy de acuerdo (5)",
    caption = "Nota: Datos ponderados. N = 2105",
    x = "sexo",
    y = "Porcentaje de acuerdo"
...
grafico <- ggplot(acuerdo, aes(x = edad_tramos, y = prop_acuerdo)) +
  ...
  scale_y_continuous(labels = scales::percent_format(accuracy = 1)) +
  labs(
    title = "Acuerdo con que alto nivel vida dueños empresas es por pagar poco por tramo etario",
    subtitle = "Proporción que responde De acuerdo (4) o Muy de acuerdo (5)",
    caption = "Nota: Datos ponderados. N = 2105",
    x = "Tramo de edad",
    y = "Porcentaje de acuerdo"
...
grafico <- ggplot(acuerdo, aes(x = sexo, y = prop_acuerdo)) +
  ...
  scale_y_continuous(labels = scales::percent_format(accuracy = 1)) +
  labs(
    title = "Acuerdo: aumentar impuestos a los más ricos por sexo",
    subtitle = "Proporción que responde De acuerdo (4) o Muy de acuerdo (5)",
    caption = "Nota: Datos ponderados. N = 2105",
    x = "sexo",
    y = "Porcentaje de acuerdo"
...
grafico <- ggplot(acuerdo, aes(x = edad_tramos, y = prop_acuerdo)) +
  ...
  scale_y_continuous(labels = scales::percent_format(accuracy = 1)) +
  labs(
    title = "Acuerdo: aumentar impuestos a los más ricos por tramo etario",
    subtitle = "Proporción que responde De acuerdo (4) o Muy de acuerdo (5)",
    caption = "Nota: Datos ponderados. N = 2105",
    x = "Tramo de edad",
    y = "Porcentaje de acuerdo"
...
grafico <- ggplot(acuerdo, aes(x = sexo, y = prop_acuerdo)) +
  ...
  scale_y_continuous(labels = scales::percent_format(accuracy = 1)) +
  labs(
    title = "Acuerdo: disminuir gasto público para evitar inflación por sexo",
    subtitle = "Proporción que responde De acuerdo (4) o Muy de acuerdo (5)",
    caption = "Nota: Datos ponderados. N = 2105",
    x = "sexo",
    y = "Porcentaje de acuerdo"
...
grafico <- ggplot(acuerdo, aes(x = edad_tramos, y = prop_acuerdo)) +
  ...
  scale_y_continuous(labels = scales::percent_format(accuracy = 1)) +
  labs(
    title = "Acuerdo: disminuir gasto público para evitar inflación por tramo etario",
    subtitle = "Proporción que responde De acuerdo (4) o Muy de acuerdo (5)",
    caption = "Nota: Datos ponderados. N = 2105",
    x = "Tramo de edad",
    y = "Porcentaje de acuerdo"
